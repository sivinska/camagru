    ...
    <?php
        ...
        <div id="div_use_webcam">
            ...
            <div id="div_choose_trees">
                <img src="../images/arrow1080x.png" class="i_trees active" width="10%">
                <img src="../images/whitesmoke.11.png" class="i_trees" width="10%">
                <img src="../images/wolfoverlay.png" class="i_trees" width="10%">
                <img src="../images/trianglepaintswash.png" class="i_trees" width="10%">
                <img src="../images/circlestreak.png" class="i_trees" width="10%">
                <img src="../images/ponygirl.png" class="i_trees" width="10%">
                <img src="../images/smoketexturepng2.png" class="i_trees" width="10%">
                <img src="../images/octogon.png" class="i_trees" width="10%">
            </div>
        </div>
        </div>
        ...
        <canvas id="canvas_copy" width="600" height="600"></canvas>
        <canvas id="canvas_tree" width="600" height="600"></canvas>
